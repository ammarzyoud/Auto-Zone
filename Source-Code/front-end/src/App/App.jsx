...
import Modify from "../AdminDashboard/Modify";
import notAllowed from "../404/notAllowed";
        ...
        <div>
          ...
          <Router history={history}>
            <Switch>
              ...
              <PrivateRoute exact path="/Shopping" component={AllProducts} />
              <PrivateRoute_A exact path="/Modify" component={Modify} />
              <PrivateRoute_A exact path="/Edit/:id" component={Edit} />
              <PrivateRoute exact path="/404" component={notAllowed} />
              <PrivateRoute_A
                exact
                path="/AdminDashboard"
